        ...
        <div class="container">
            <div class="site-header-inner">
                <div class="brand header-brand">
                    <h1 class="m-0"> <a href="#"> <img width="128" height="128" viewBox="0 0 32 32" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/Web 1.png"> </a> </h1>
                </div>
            </div>
        </div>
    </header>
        ...
        <section class="hero text-center">
            <div class="container-sm">
                <div class="hero-inner">
                    <h1 class="hero-title h2-mobile mt-0 is-revealing"> پتاسیم وب </h1>
                    <h4 class="hero-title h2-mobile mt-0 is-revealing">  طراح وبسایت  </h4>
                    <div class="hero-form newsletter-form field field-grouped is-revealing">
                        <div class="control control-expanded">
                            <input class="input" type="email" name="email" placeholder="ایمیل شما&hellip;">
                        </div>
                        <div class="control">
                            <a class="button button-primary button-block button-shadow" href="#">ثبت نام </a>
                        </div>
                    </div>
                    <div class="hero-browser">
                        ...
                        <div class="hero-browser-inner is-revealing">
                            <svg width="800" height="450" viewBox="0 0 800 450" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                ...
                                <g fill="none" fill-rule="evenodd">
                                    <rect width="800" height="450" rx="4" fill="#FFF" style="mix-blend-mode:multiply;filter:url('<?php echo esc_url( get_template_directory_uri() ); ?>/#dropshadow-1')"/>
                    ...
                    <div class="features-wrap">
                        <div class="feature is-revealing">
                            <div class="feature-inner">
                                ...
                                <h3 class="feature-title">توسعه</h3>
                                <p class="text-sm"><?php _e( 'توسعه دهی و Developer بودن از ویژگی های هر سایت طراحی است که تیم ما نیز از این موضوع بی بهره نیست.', 'k_web_test' ); ?></p>
                            </div>
                        </div>
                        <div class="feature is-revealing">
                            <div class="feature-inner">
                                ...
                                <p class="text-sm">قیمت های هر محصول با توجه به ساختار آن محصول متناوب هستند و اصل موضوع مناسب بودن قیمت محصولات تیم طراحی ماست!</p>
                            </div>
                        </div>
                    </div>
                    <center class="features-wrap">
                        <div class="feature is-revealing">
                            <div class="feature-inner" dir="center">
                                <div class="feature-icon">
                                    <svg width="80" height="80" dir=" center" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h3 class="feature-title">طراحی</h3>
                                <p class="text-sm"><?php _e( 'طراحی حرفه ای سایت های HTML و Wordpress با استفاده از زبان های HTML , CSS , Php , SQL , Javascript توسط تیم ما صورت میگیرد', 'k_web_test' ); ?></p>
                            </div>
                        </div>
                    </center>
                </div>
            ...
            <div class="container-sm">
                <div class="newsletter-inner section-inner">
                    <div class="newsletter-header text-center is-revealing">
                        <h2 class="section-title mt-0">  هم اکنون سفارش خود را ثبت کنید!</h2>
                    ...
                    <div class="footer-form newsletter-form field field-grouped is-revealing">
                        ...
                        <div class="control">
                            <a class="button button-primary button-block button-shadow" href="#">ثبت سفارش   </a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="site-footer-inner">
                <div class="brand footer-brand">
                    <a href="#"> <img class="img-circle" width="100" height="100" viewBox="0 0 32 32" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/Web 1.png"> </a>
                </div>
                ...
                <ul class="footer-social-links list-reset">
                    <li>
                        <a href="#"> <span class="screen-reader-text"><?php _e( 'Facebook', 'k_web_test' ); ?></span> <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="#"> <span class="screen-reader-text"><?php _e( 'Twitter', 'k_web_test' ); ?></span> <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg">
                                <path d="M16 3c-.6.3-1.2.4-1.9.5.7-.4 1.2-1 1.4-1.8-.6.4-1.3.6-2.1.8-.6-.6-1.5-1-2.4-1-1.7 0-3.2 1.5-3.2 3.3 0 .3 0 .5.1.7-2.7-.1-5.2-1.4-6.8-3.4-.3.5-.4 1-.4 1.7 0 1.1.6 2.1 1.5 2.7-.5 0-1-.2-1.5-.4C.7 7.7 1.8 9 3.3 9.3c-.3.1-.6.1-.9.1-.2 0-.4 0-.6-.1.4 1.3 1.6 2.3 3.1 2.3-1.1.9-2.5 1.4-4.1 1.4H0c1.5.9 3.2 1.5 5 1.5 6 0 9.3-5 9.3-9.3v-.4C15 4.3 15.6 3.7 16 3z" fill="#FFFFFF"/>
                            </svg> </a>
                    </li>
                    <li>
                        <a href="#"> <span class="screen-reader-text"><?php _e( 'Google', 'k_web_test' ); ?></span> <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="footer-copyright">
                    <?php _e( '&copy; تمامی حقوق برای K-Web محفوظ است', 'k_web_test' ); ?>
                </div>
            </div>
        </div>
    </footer>
